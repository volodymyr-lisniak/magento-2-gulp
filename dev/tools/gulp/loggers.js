...
module.exports = {
    ...
    help: () => {
        console.log(
            ...
            color('  svg-sprite-creating            ', 'GREEN'),
            color('Create svg sprite with styles\n', 'WHITE'),
            color('  svg-sprite-creating-cleaning   ', 'GREEN'),
            color('Create svg sprite after delete its old files\n', 'WHITE'),
            color('  exec                           ', 'GREEN'),
